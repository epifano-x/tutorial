...
int pos = 0, lin = 3, col = 7,lim = 10;
    ...
    do {
        gotoxy(col,lin); printf("    Arquivo");
        gotoxy(col,lin + 2); printf("   Bubble Sort");
        gotoxy(col,lin + 4); printf("Insertion Sort");
        gotoxy(col,lin + 6); printf("   Shelll Sort");
        gotoxy(col,lin + 8); printf("Selection Sort");
        gotoxy(col,lin + 10); printf("    Quick Sort");
...
int pos = 0, lin = 3, col = 7,lim = 2;
    ...
    do {
        gotoxy(col,lin); printf("Abrir Arquivo");
        gotoxy(col,lin + 2); printf("Gerar Arquivo");
...
void _quickSort_(registro vetor, int inicio, int fim)
{
    ...
    while (i <= j)
    {
        ...
        if (i <= j)
        {
            auxiliar = strRegistro.vetor[i];
            strRegistro.vetor[i] = strRegistro.vetor[j];
            strRegistro.vetor[j] = auxiliar;
            i++;
            j--;
        }
    }
